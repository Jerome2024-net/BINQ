...
export default function AccessDashboardPage() {
  ...
  const statCards = [
    { label: "Présents", value: stats.presents, icon: UserCheck, color: "blue" },
  ...
  return (
    <AccessLayout>
      ...
      <div className="grid grid-cols-2 gap-3 mb-6">
        <Link
          href="/access/scanner"
          className="bg-blue-500 text-white rounded-2xl p-4 flex items-center gap-3 active:scale-[0.97] transition-transform shadow-lg shadow-blue-500/25"
        >
      ...
      {spaces.length > 0 && (
        <div className="mb-6">
          <div className="flex items-center justify-between mb-3">
            ...
            <Link href="/access/espaces" className="text-[13px] font-semibold text-blue-600 flex items-center gap-1">
            ...
            {spaces.slice(0, 4).map((space) => (
              ...
              >
                ...
                <div className={`mt-2 inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-semibold ${
                  space.actif ? "bg-blue-50 text-blue-600" : "bg-gray-100 text-gray-500"
                }`}>
                  <span className={`w-1.5 h-1.5 rounded-full ${space.actif ? "bg-blue-500" : "bg-gray-400"}`} />
      ...
      <div>
        <div className="flex items-center justify-between mb-3">
          ...
          {logs.length > 0 && (
            <Link href="/access/historique" className="text-[13px] font-semibold text-blue-600 flex items-center gap-1">
