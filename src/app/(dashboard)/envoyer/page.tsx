  ...
  return (
    <div className="space-y-5 pb-8">
      ...
      <div>
        ...
        <p className="text-gray-700 text-sm mt-0.5">Transfert instantané et gratuit.</p>
      </div>
          ...
          {DEVISE_LIST.map((d) => (
            <button
              ...
              className={`px-2 py-1.5 text-[10px] font-bold transition-all ${
                devise === d ? "bg-emerald-50 text-emerald-600" : "text-gray-600 hover:text-gray-700"
              }`}
            >
              {DEVISES[d].flag} {d}
            </button>
        ...
        <div className="rounded-2xl bg-gray-50/50 border border-gray-200/50 p-5 space-y-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-gray-600">Recherchez par nom ou prénom</p>
            </div>
          </div>
              ...
              {searchResults.map((u) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-[10px] text-gray-600">Membre Binq</p>
                  </div>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[10px] text-gray-600">Destinataire</p>
              </div>
            </div>
            <button onClick={reset} className="p-2 rounded-xl bg-gray-50/80 hover:bg-gray-100 text-gray-600 transition-colors">
              <X className="w-4 h-4" />
            </button>
          </div>

          <div className="rounded-2xl bg-gray-50/50 border border-gray-200/50 p-4 sm:p-6">
            <p className="text-[10px] font-bold text-gray-700 uppercase tracking-wider text-center mb-3 sm:mb-4">Montant</p>
            <input
              type="number"
              min="1"
              step="0.01"
      ...
      {step === "confirm" && selectedUser && (
        <div className="rounded-2xl bg-gray-50/50 border border-gray-200/50 p-5 space-y-5">
          <div className="rounded-2xl bg-gray-50/50 border border-gray-200/50 p-4 sm:p-6 text-center">
            <p className="text-[10px] font-bold text-gray-700 uppercase tracking-wider mb-2">Vous envoyez</p>
            ...
            <div className="flex items-center justify-center gap-2">
              <span className="text-sm text-gray-700">à</span>
            ...
            {message && (
              <p className="mt-4 text-sm text-gray-700 italic">&ldquo;{message}&rdquo;</p>
            )}
            <div className="mt-6 pt-4 border-t border-gray-200/50 text-left space-y-2">
              ...
              <div className="flex justify-between text-sm font-bold">
                <span className="text-gray-700">Total débité</span>
          ...
          <div className="flex gap-3">
            <button onClick={() => setStep("amount")} className="flex-[1] py-4 rounded-xl border border-gray-200/60 text-gray-600 font-bold hover:bg-gray-50/80 transition-colors text-sm active:scale-[0.98]">
              Retour
            </button>
            <button
              onClick={handleSend}
