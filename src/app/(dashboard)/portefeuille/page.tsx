    ...
    <div className="space-y-5 pb-28">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500 text-xs mt-0.5">G&eacute;rez votre argent</p>
        </div>
        ...
        <div className="relative z-10">
          <div className="flex items-center justify-between mb-3 sm:mb-5">
            <div className="flex items-center gap-2">
              ...
              <div className="flex items-center bg-white/10 rounded-lg overflow-hidden">
                {DEVISE_LIST.map((d) => (
                  <button key={d} onClick={() => switchDevise(d)} className={`px-2.5 py-1 text-[10px] sm:text-xs font-bold transition-all ${devise === d ? "bg-white/30 text-white" : "text-white/60 hover:text-white/80"}`}>
                    {DEVISES[d].flag} {d}
                  </button>
                ))}
              </div>
          ...
          <div className="grid grid-cols-4 gap-2">
            <Link href="/deposer" className="flex flex-col items-center gap-1 sm:gap-1.5 py-2.5 sm:py-3 rounded-xl sm:rounded-2xl bg-white/15 backdrop-blur-sm hover:bg-white/25 transition-all active:scale-95 text-white">
              ...
              <span className="text-[10px] sm:text-[11px] font-bold">D&eacute;poser</span>
            </Link>
            ...
            <Link href="/qrcode" className="flex flex-col items-center gap-1 sm:gap-1.5 py-2.5 sm:py-3 rounded-xl sm:rounded-2xl bg-white/15 backdrop-blur-sm hover:bg-white/25 transition-all active:scale-95 text-white">
              <QrCode className="w-4 h-4 sm:w-5 sm:h-5" />
              <span className="text-[10px] sm:text-[11px] font-bold">QR Pay</span>
            </Link>
            <Link href="/envoyer" className="flex flex-col items-center gap-1 sm:gap-1.5 py-2.5 sm:py-3 rounded-xl sm:rounded-2xl bg-white/15 backdrop-blur-sm hover:bg-white/25 transition-all active:scale-95 text-white">
