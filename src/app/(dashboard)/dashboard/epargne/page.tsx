  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 tracking-tight">Mon Épargne</h1>
          ...
          <div className="relative z-10">
            ...
            <div className="space-y-1">
              ...
              {epargnes.filter(e => e.devise === "USD").length > 0 && (
                <p className="text-2xl font-bold tracking-tight opacity-90">
                  {formatDevise(epargnes.filter(e => e.devise === "USD").reduce((sum, e) => sum + Number(e.solde), 0), "USD")}
                </p>
              )}
              {epargnes.length === 0 && <p className="text-3xl font-bold tracking-tight">0,00 €</p>}
            </div>
          </div>
          ...
          {epargnes.map((ep) => {
            ...
            return (
              <button
                ...
                className="group relative flex flex-col bg-white rounded-3xl border border-gray-100 p-6 shadow-sm hover:shadow-xl hover:translate-y-[-2px] hover:border-indigo-100 transition-all text-left duration-300"
              >
                {/* Header Card */}
                ...
                <div className="mb-6">
                  ...
                  <p className="text-3xl font-bold text-gray-900 tracking-tight">{formatDevise(Number(ep.solde), ep.devise)}</p>
                </div>
