            ...
            <button
              onClick={() => {
                ...
                const msg = encodeURIComponent(
                  ...
                  `📅 ${formatDate(event.date_debut)}${event.heure_debut ? ` à ${formatTime(event.heure_debut)}` : ""}\n` +
              ...
              className="w-full py-3.5 bg-green-500 text-white rounded-2xl font-bold text-sm flex items-center justify-center gap-2 transition hover:bg-green-600 active:scale-[0.98]"
            >
              ...
              Recevoir mon billet par WhatsApp
            </button>
          </div>
        )}
