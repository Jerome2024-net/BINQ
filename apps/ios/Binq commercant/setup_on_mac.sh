...
APP_NAME="Binq Commerçant"
BUNDLE_ID="io.binq.commercant"
ORG="io.binq"
...
if [ -f "ios/Runner/Info.plist" ]; then
  ...
  /usr/libexec/PlistBuddy -c "Add :NSLocationWhenInUseUsageDescription string Binq utilise la position de votre commerce pour les livraisons locales." ios/Runner/Info.plist 2>/dev/null \
    || /usr/libexec/PlistBuddy -c "Set :NSLocationWhenInUseUsageDescription Binq utilise la position de votre commerce pour les livraisons locales." ios/Runner/Info.plist
fi
